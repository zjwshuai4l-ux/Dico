...
class UXNET(nn.Module):
    ...
    def     __init__(
        ...
        # self.change_ch_384 = nn.Conv3d(feat_size[3], 2, kernel_size=3, stride=1, padding=1)
        # self.change_ch_192 = nn.Conv3d(feat_size[2], 2, kernel_size=3, stride=1, padding=1)
        # self.change_ch_96 = nn.Conv3d(feat_size[1], 2, kernel_size=3, stride=1, padding=1)
        # self.change_ch_48 = nn.Conv3d(feat_size[0], 2, kernel_size=3, stride=1, padding=1)
    ...
    def forward(self, x_in):
        ...
        # out_5 = self.change_ch_384(dec3)
        # dec2 = self.decoder4(dec3, enc3)
        # out_4 = self.change_ch_192(dec2)
        # dec1 = self.decoder3(dec2, enc2)
        # out_3 = self.change_ch_96(dec1)
        # dec0 = self.decoder2(dec1, enc1)
        # out_2 = self.change_ch_48(dec0)
